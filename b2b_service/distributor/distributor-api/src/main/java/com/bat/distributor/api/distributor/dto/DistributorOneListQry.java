...
@Data
@ApiModel(value = "DistributorOneListQry", description = "一级分销商列表查询")
public class DistributorOneListQry {
    @ApiModelProperty(value = "查询内容，分销商登录名/客户名/分销商ID/分销商ERP编码，名称支持模糊查询", required = false, example = "bat")
    private String content;
    @ApiModelProperty(value = "查询内容类型，1 分销商登录名 2 客户名 3 分销商ID 4 分销商ERP编码，(查询内容不为空是必填) 5.手机号", required = false,
        example = "bat")
