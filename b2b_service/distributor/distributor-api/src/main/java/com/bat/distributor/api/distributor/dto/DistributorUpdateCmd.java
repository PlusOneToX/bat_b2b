...
public class DistributorUpdateCmd {

    @NotNull(message = "P_DISTRIBUTOR_ID_NULL")
    @ApiModelProperty(value = "分销商id", required = false)
    private Integer id;
    ...
    private DistributorBusinessUpdateCmd business;
    @Valid
    @ApiModelProperty(value = "分销商价格等级", required = true)
...
//    @NotNull(message = "P_DISTRIBUTOR_CONTACTS_NULL")
    ...
    @ApiModelProperty(value = "分销商分账后台参数配置")
