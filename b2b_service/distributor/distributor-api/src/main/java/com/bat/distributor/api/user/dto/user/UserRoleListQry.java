...
@Data
@ApiModel(value = "UserRoleListQry", description = "分销商联系人角色列表查询")
public class UserRoleListQry {
    @ApiModelProperty(value = "查询内容，分销商联系人角色名称，支持模糊查询", required = false, example = "bat")
