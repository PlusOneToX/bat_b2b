package com.bat.distributor.db.config;
...
import com.bat.distributor.common.ApplicationContextProvider;
import com.bat.distributor.common.ErrorCode;
import com.bat.distributor.db.service.executor.TenantDBQry;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw DistributorException.buildException(ErrorCode.TENANT_DB_NULL);
                }
                dbName = tenantDB.getDbName();
