package com.bat.distributor.web.aop;
...
import com.bat.distributor.web.base.Response;
...
public class CommonLogAop extends BaseController {
    ...
    @Pointcut("@annotation(com.bat.distributor.web.annotation.SysLog)")
    ...
    public void afterThrowing(JoinPoint joinPoint, SysLog sysLog, Exception ex) {
        try {
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                if (ex instanceof DistributorException) {
                    DistributorException distributorException = (DistributorException)ex;
                    code = distributorException.getCode();
                    msg = distributorException.getMsg();
                }
                ...
                sendService.commonLog("distributor-service", sysLog.businessFunction(), businessId, platform,
