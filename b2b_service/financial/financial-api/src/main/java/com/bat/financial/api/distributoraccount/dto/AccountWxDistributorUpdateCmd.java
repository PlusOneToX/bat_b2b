 ...
 */
@Data
@ApiModel(value = "AccountWxDistributorUpdateCmd", description = "分销商收款账户(微信)更新")
public class AccountWxDistributorUpdateCmd {

    @NotNull(message = "P_ACCOUNT_WXPAY_DISTRIBUTOR_ID_NULL")
