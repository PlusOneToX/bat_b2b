 ...
 */
@Data
@ApiModel(value = "AccountAlipayUpdateCmd", description = "平台收款账户(支付宝)更新")
public class AccountAlipayUpdateCmd {

    @NotNull(message = "P_ACCOUNT_ALIPAY_ID_NULL")
    ...
    @NotBlank(message = "P_ACCOUNT_ALIPAY_BANK_NO_NULL")
    ...
    @NotBlank(message = "P_ACCOUNT_ALIPAY_PUBLIC_KEY_NULL")
    ...
    @NotBlank(message = "P_ACCOUNT_ALIPAY_PRIVATE_KEY_NULL")
