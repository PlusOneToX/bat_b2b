 ...
 */
@Data
@ApiModel(value = "AccountOfflineUpdateCmd", description = "平台收款账户(线下)更新")
public class AccountOfflineUpdateCmd {

    @NotNull(message = "P_ACCOUNT_OFFLINE_ID_NULL")
    ...
    @ApiModelProperty(value = "erp银行账号", required = true, example = "752371968649")
    private String bankNo;

    @NotBlank(message = "P_ACCOUNT_OFFLINE_CARD_NO_NULL")
    @ApiModelProperty(value = "银行卡号", required = true, example = "752371968649")
    private String cardNo;

    @NotBlank(message = "P_ACCOUNT_OFFLINE_BANK_NAME_NULL")
    @ApiModelProperty(value = "开户行名称", required = true, example = "中国银行深圳市分行沙河支行")
    private String bankName;

    @NotBlank(message = "P_ACCOUNT_OFFLINE_BANK_ADDR_NULL")
    @ApiModelProperty(value = "开户行地址", required = true, example = "")
