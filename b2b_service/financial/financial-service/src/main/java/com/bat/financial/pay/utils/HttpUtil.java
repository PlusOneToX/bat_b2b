...
public class HttpUtil {
    ...
    // 同步B2B
    public static <T> T postJson(String url, Long distributorId, String orderSource, long timestamp, String sign,
        Object requestObject, Class<T> responseClass) {
        Gson gson = new GsonBuilder().create();
        String requestJson = gson.toJson(requestObject);
    ...
    public static String request(String url, String requestJson, String requestMethod, Map<String, String> headers) {
        ...
        try {
            ...
            if (connection.getResponseCode() != HttpURLConnection.HTTP_OK) {
                ...
                throw new Exception("请求失败url:" + url + ",status code:" + connection.getResponseCode() + ",error:"
    ...
    // 含有请求头的
    public static <T> T postJsonWithHeader(String url, String paramJson, Map<String, Object> headerMap,
