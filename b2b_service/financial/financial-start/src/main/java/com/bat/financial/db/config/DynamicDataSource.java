package com.bat.financial.db.config;
...
import com.bat.financial.common.ApplicationContextProvider;
import com.bat.financial.common.ErrorCode;
import com.bat.financial.db.service.executor.TenantDBQry;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw FinancialException.buildException(ErrorCode.TENANT_DB_NULL);
                }
                dbName = tenantDB.getDbName();
