package com.bat.financial.web.aop;
...
public class CommonLogAop extends BaseController {
    ...
    @Pointcut("@annotation(com.bat.financial.web.annotation.SysLog)")
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                try {
                    ...
                    if (id != null && StringUtils.isNotBlank(id.toString())) {
                        ...
                        if (proceed != null && proceed.getData() != null) {
    ...
    public void afterThrowing(JoinPoint joinPoint, SysLog sysLog, Exception ex) {
        try {
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                if (ex instanceof FinancialException) {
                    FinancialException financialException = (FinancialException)ex;
                    code = financialException.getCode();
                    msg = financialException.getMsg();
                }
                ...
                sendService.commonLog("financial-service", sysLog.businessFunction(), businessId, platform, finalUserId,
                    userName, sysLog.value(), operateDes, operateData, new Date());
                TenantContext.removeTenantNo();
            });
        } catch (Exception e) {
