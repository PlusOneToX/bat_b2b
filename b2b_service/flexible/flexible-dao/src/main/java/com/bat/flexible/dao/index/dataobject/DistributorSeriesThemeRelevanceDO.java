...
public class DistributorSeriesThemeRelevanceDO {
    private Integer id;

    private Integer seriesThemeId;
    ...
    public Integer getSeriesThemeId() {
        return seriesThemeId;
    }

    public void setSeriesThemeId(Integer seriesThemeId) {
