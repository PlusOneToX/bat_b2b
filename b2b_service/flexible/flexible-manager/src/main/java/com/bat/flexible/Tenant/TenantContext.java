package com.bat.flexible.Tenant;
...
public class TenantContext {
    ...
    public static String getTenantDbName() {
        ...
        return StringUtils.isNotBlank(tenantNo) && tenantInfoMap.get(tenantNo).getConfigMap().get("dbName") != null
            ? tenantInfoMap.get(tenantNo).getConfigMap().get("dbName") : null;
    }
