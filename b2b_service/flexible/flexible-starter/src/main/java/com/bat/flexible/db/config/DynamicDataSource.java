package com.bat.flexible.db.config;
...
import com.bat.flexible.common.ApplicationContextProvider;
import com.bat.flexible.common.ErrorCode;
import com.bat.flexible.db.service.executor.TenantDBQry;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw new FlexibleCustomException(MessageUtils.get(ErrorCode.TENANT_DB_NULL));
                }
                dbName = tenantDB.getDbName();
