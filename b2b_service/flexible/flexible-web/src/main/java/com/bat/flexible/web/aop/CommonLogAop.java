package com.bat.flexible.web.aop;
...
public class CommonLogAop extends BaseController {
    ...
    @Pointcut("@annotation(com.bat.flexible.web.annotation.SysLog)")
    ...
    public void afterThrowing(JoinPoint joinPoint, SysLog sysLog, Exception ex) {
        try {
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                if (ex instanceof FlexibleDubboApiException) {
                    FlexibleDubboApiException flexibleDubboApiException = (FlexibleDubboApiException)ex;
                    code = flexibleDubboApiException.getCode();
                    msg = flexibleDubboApiException.getMsg();
                }
                ...
                sendService.commonLog("flexible-service", sysLog.businessFunction(), businessId, platform, finalUserId,
                    userName, sysLog.value(), operateDes, operateData, new Date());
                TenantContext.removeTenantNo();
            });
        } catch (Exception e) {
