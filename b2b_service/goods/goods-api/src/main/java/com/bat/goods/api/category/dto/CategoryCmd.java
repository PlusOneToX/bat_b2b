...
@Data
@ApiModel(value = "CategoryCmd", description = "品类信息")
public class CategoryCmd {

    @ApiModelProperty(value = "品类ID", required = false)
    private Integer id;
    @NotBlank(message = "P_GOODS_CATEGORY_NAME_NULL")
    @ApiModelProperty(value = "品类名称,最长20个字符", required = true, example = "bat")
    private String name;
    @ApiModelProperty(value = "品类英文名称，最长100个字符", required = false, example = "bat")
    private String nameEn;
    @ApiModelProperty(value = "品类描述,最长300个字符", required = false, example = "bat品牌")
