...
@Data
@ApiModel(value = "ScalePriceListQry", description = "价格等级列表查询")
public class ScalePriceListQry {
    @ApiModelProperty(value = "查询内容，价格等级名称，支持模糊查询", required = false, example = "bat")
