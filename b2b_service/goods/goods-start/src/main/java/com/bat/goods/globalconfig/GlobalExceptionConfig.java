...
public class GlobalExceptionConfig {
    ...
    public Response bindHandler(Exception e) {
        ...
        if (StringUtils.isNotBlank(msg)) {
            return Response.buildFailure(ErrorCode.P_NOTNULL, msg);
        } else {
            return Response.buildFailure(ErrorCode.P_NOTNULL, ErrorCode.P_NOTNULL);
        }
    }
    ...
    public Response goodsHandler(GoodsException e) {
        e.printStackTrace();
