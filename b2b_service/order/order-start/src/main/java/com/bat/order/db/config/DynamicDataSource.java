package com.bat.order.db.config;

import static com.bat.order.common.ErrorCode.TENANT_DB_NULL;
...
import com.bat.order.db.service.executor.TenantDBQry;
...
import com.bat.order.common.ApplicationContextProvider;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw OrderException.buildException(TENANT_DB_NULL);
                }
                dbName = tenantDB.getDbName();
