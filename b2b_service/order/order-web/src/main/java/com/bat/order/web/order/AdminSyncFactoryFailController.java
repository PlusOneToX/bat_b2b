 ...
 * 沙漠
 */
@Api(tags = "同步工厂失败订单后台接口")
@RequestMapping(value = "/order/v1/web/admin/syncFactoryFail")
@RestController
public class AdminSyncFactoryFailController extends BaseController {
    ...
    // @SysLog(businessFunction= CommonLogTypeTitleConstantDTO.AdminSyncFactoryFail,value =
    // CommonLogTypeConstantDTO.AdminSyncFactoryFailList)
    ...
    // @SysLog(businessFunction= CommonLogTypeTitleConstantDTO.AdminSyncFactoryFail,value =
    // CommonLogTypeConstantDTO.AdminSyncFactoryFailDetail)
    ...
    // @SysLog(businessFunction= CommonLogTypeTitleConstantDTO.AdminSyncFactoryFail,value =
    // CommonLogTypeConstantDTO.AdminSyncFactoryFailExport)
    @GetMapping("/export")
