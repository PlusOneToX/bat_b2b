...
public class GroupSeckillDTO {
    ...
    private List<GroupSeckillDistributorScopeDTO> distributors;
    ...
    private List<GroupSeckillDistributorScopeDTO> distributorNos;

    @ApiModelProperty(value = "拼团秒杀商品列表")
    private List<GroupSeckillGoodsDTO> goods;
}
