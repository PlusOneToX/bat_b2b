...
public class UserPromotionRuleConditionDTO {
    ...
    private List<UserPromotionRuleConditionPresentDTO> presents;
    @ApiModelProperty(value = "特价商品列表")
    private List<UserPromotionRuleConditionSpecialDTO> specials;
