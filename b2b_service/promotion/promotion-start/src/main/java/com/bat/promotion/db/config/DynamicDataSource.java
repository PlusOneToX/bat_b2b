...
import static com.bat.promotion.common.ErrorCode.TENANT_DB_NULL;
...
import com.bat.promotion.db.service.executor.TenantDBQry;
...
import com.bat.promotion.common.ApplicationContextProvider;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw PromotionException.buildException(TENANT_DB_NULL);
                }
                dbName = tenantDB.getDbName();
