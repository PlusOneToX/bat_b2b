package com.bat.promotion.swagger;
...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("营销推广服务接口文档").description("")
            .contact(new Contact("bat", "https://bat.com", "info@bat.hk")).version("1.0.0").build();
    }
