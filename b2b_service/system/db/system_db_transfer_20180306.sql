...
-- ----------------------------
INSERT INTO system_db_101.check_config(id,
                                       ext,
                                       check_user,
                                       check_order,
                                       open_flag,
...
INSERT INTO system_db_101.download_center(id,
                                          parent_id,
                                          sort,
                                          status,
                                          title_zh,
...
SELECT id,
       ...
       FROM_UNIXTIME(`create_time` / 1000, '%Y-%m-%d %H:%i:%S'),
       FROM_UNIXTIME(`update_time` / 1000, '%Y-%m-%d %H:%i:%S')
from b2b_bat.download_center;

INSERT INTO system_db_101.training_center(id,
                                          parent_id,
                                          sort,
                                          status,
                                          title_zh,
...
INSERT INTO `system_db_101`.`global_base_setting`(`key`, `value`, `desc`)
...
INSERT INTO system_db_101.global_factory_setting_delay_push(id,
                                                            factory,
                                                            push_time,
                                                            use_range,
                                                            type)
SELECT id,
       ...
       use_range,
       type
from b2b_bat.delay_push;

INSERT INTO system_db_101.global_factory_setting_order_invalid(id,
                                                               name,
                                                               order_source,
                                                               invalid)
SELECT id,
...
-- ----------------------------
-- Table transfer for system_db_101.logistics module
-- ----------------------------
INSERT INTO system_db_101.logistics (id,
                                     `name`,
                                     sort,
                                     `enable`,
                                     description,
...
SELECT id,
       ...
       FROM_UNIXTIME(`create_time` / 1000, '%Y-%m-%d %H:%i:%S'),
       FROM_UNIXTIME(`update_time` / 1000, '%Y-%m-%d %H:%i:%S')
FROM b2b_bat.distribution;

INSERT INTO system_db_101.logistics_area (id,
                                          logistics_id,
                                          first_weight_cost,
                                          first_volume_cost,
...
SELECT id,
       ...
       city_id,
       0             district_id
FROM b2b_bat.distribution_area
GROUP BY distribution_id, formula, province_id, city_id;

INSERT INTO system_db_101.logistics_distributor_grade(id,
                                                      logistics_id,
                                                      distributor_grade_id)
SELECT id,
       distribution_id,
       distributor_grade_id
FROM b2b_bat.distribution_distributor_grade_scope;

INSERT INTO system_db_101.logistics_department(id,
                                               logistics_id,
                                               department_id)
SELECT id,
       distribution_id,
       department_id
FROM b2b_bat.distribution_department_scope;

INSERT INTO system_db_101.logistics_user(id,
                                         logistics_id,
                                         user_id)
SELECT id,
       distribution_id,
       admin_id user_id
FROM b2b_bat.distribution_admin_scope;

INSERT INTO system_db_101.logistics_distributor(id,
                                                logistics_id,
                                                distributor_id)
SELECT id,
       distribution_id,
       distributor_id
FROM b2b_bat.distribution_distributor_scope;

INSERT INTO system_db_101.logistics_third_mapping(id,
                                                  logistics_id,
                                                  third_type,
                                                  status,
                                                  third_delivery_no,
...
SELECT id,
       ...
       third_delivery_no,
       remark
FROM b2b_bat.third_delivery_rela;

-- ----------------------------
-- Table transfer for region module
-- ----------------------------

-- INSERT INTO system_db_101.region(id,
--                              region_name,
--                              parent_id,
--                              have_next,
--                              region_name_en,
...
-- INSERT INTO system_db_101.region_comparison(id,
--                                         region_id,
--                                         region_name,
--                                         another_name,
--                                         parent_id)
...
--        another_name,
--        parent_id
-- FROM b2b_bat.region_comparison;

-- ----------------------------
-- Table transfer for store module
-- ----------------------------

INSERT INTO system_db_101.`store_banner`(id,
                                         image_url,
                                         banner_url,
                                         create_time,
                                         banner_area,
...
FROM b2b_bat.`announcement`;

INSERT INTO system_db_101.`store_column`(id,
                                         title,
                                         title_en,
                                         banner_img,
                                         sort,
...
INSERT INTO system_db_101.`store_column_department`(id,
                                                    column_id,
                                                    department_id)
SELECT id,
       column_id,
       department_id
FROM b2b_bat.`column_department_scope`;

INSERT INTO system_db_101.`store_column_distributor`(id,
                                                     column_id,
                                                     distributor_id)
SELECT id,
       column_id,
       distributor_id
FROM b2b_bat.`column_distributor_scope`;

INSERT INTO system_db_101.`store_column_distributor_grade`(id,
                                                           column_id,
                                                           distributor_grade_id)
SELECT id,
       column_id,
       distributor_grade_id
FROM b2b_bat.`column_distributor_grade_scope`;

INSERT INTO system_db_101.`store_column_user`(id,
                                              column_id,
                                              user_id)
SELECT id,
       column_id,
       admin_id
FROM b2b_bat.`column_admin_scope`;

INSERT INTO system_db_101.`store_section`(id,
                                          title,
                                          title_en,
                                          sort,
                                          release_status,
...
SELECT id,
       ...
       FROM_UNIXTIME(`create_time` / 1000, '%Y-%m-%d %H:%i:%S') create_time,
       FROM_UNIXTIME(`update_time` / 1000, '%Y-%m-%d %H:%i:%S') create_time
FROM b2b_bat.`section`;

-- ----------------------------
-- Table transfer for system module
-- ----------------------------

INSERT INTO system_db_101.sys_user(id,
                                   user_name,
                                   real_name,
                                   password,
                                   mobile,
...
INSERT INTO system_db_101.sys_role(id,
                                   role_name,
                                   role_name_en,
                                   role_description,
                                   create_time,
...
INSERT INTO system_db_101.sys_user_role(id,
                                        user_id,
                                        role_id)
SELECT id,
       user_id,
       role_id
FROM b2b_bat.admin_role;

INSERT INTO system_db_101.sys_user_brand(id,
                                         user_id,
                                         brand_id)
SELECT id,
       user_id,
       brand_id
from b2b_bat.admin_brand;

INSERT INTO system_db_101.sys_user_sale(id,
                                        user_id,
                                        sale_user_id)
SELECT id,
       user_id,
       sale_user_id
from b2b_bat.admin_sale;

INSERT INTO system_db_101.sys_user_login(id,
                                         last_login_time,
                                         login_times)
SELECT -- id,
       user_id,
       ...
       times
from b2b_bat.admin_login;


-- INSERT INTO system_db_101.sys_role_menu (id, role_id, menu_id)
-- SELECT b.id,
--        b.role_id,
--        a.id
-- FROM system_db_101.sys_menu a,
--      b2b_bat.role_menu b
-- WHERE a.menu = b.module;

INSERT INTO system_db_101.`sys_department`(id,
                                           parent_id,
                                           organization_id,
                                           department_name,
                                           department_name_en,
...
SELECT id,
       ...
       FROM_UNIXTIME(`create_time` / 1000, '%Y-%m-%d %H:%i:%S') create_time,
       FROM_UNIXTIME(`update_time` / 1000, '%Y-%m-%d %H:%i:%S') update_time
FROM b2b_bat.`department`;

INSERT INTO system_db_101.`sys_organization`(id,
                                             name,
                                             erp_organization_id,
                                             description,
                                             status,
...
SELECT id,
       ...
       FROM_UNIXTIME(`create_time` / 1000, '%Y-%m-%d %H:%i:%S') create_time,
       FROM_UNIXTIME(`update_time` / 1000, '%Y-%m-%d %H:%i:%S') update_time
FROM b2b_bat.`sale_organization`;