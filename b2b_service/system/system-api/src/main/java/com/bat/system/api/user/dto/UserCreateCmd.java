 ...
 */
@Data
@ApiModel(value = "UserCreateCmd", description = "后台用户新增")
public class UserCreateCmd {
    ...
    @ApiModelProperty(value = "手机号", required = false, example = "18995912083")
    ...
    @ApiModelProperty(value = "品牌范围类型 0无 1.全局 2.其他", required = false, example = "1")
    ...
    @ApiModelProperty(value = "ERP_用户编码", required = false, example = "RQ000421")
    ...
    @ApiModelProperty(value = "部门id", required = false, example = "1")
    private Integer departmentId;

    // @NotNull(message = "P_ROCK_ACCOUNT_ID_NULL")
    @ApiModelProperty(value = "账户中心id", required = false, example = "1")
