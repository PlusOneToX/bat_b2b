package com.bat.system.db.config;

import static com.bat.system.common.ErrorCode.TENANT_DB_NULL;
...
import com.bat.system.common.ApplicationContextProvider;
import com.bat.system.db.service.executor.TenantDBQry;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw SystemException.buildException(TENANT_DB_NULL);
                }
                dbName = tenantDB.getDbName();
