package com.bat.thirdparty.common.swagger;
...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("第三方服务接口文档").description("")
            .contact(new Contact("", "https://www.bat.com", "info@bat.hk")).version("1.0.0").build();
    }
