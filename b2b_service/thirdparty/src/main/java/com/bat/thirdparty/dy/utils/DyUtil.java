package com.bat.thirdparty.dy.utils;
...
public class DyUtil {
    ...
    private static final Logger log = LoggerFactory.getLogger(DyUtil.class);
     ...
     * @return
     */
    public static DyUserInfoDTO getUserInfo(String encryptedData, String sessionKey, String iv) {
        ...
        try {
            ...
            if (null != resultByte && resultByte.length > 0) {
                ...
                return JSON.parseObject(result, DyUserInfoDTO.class);
            }
