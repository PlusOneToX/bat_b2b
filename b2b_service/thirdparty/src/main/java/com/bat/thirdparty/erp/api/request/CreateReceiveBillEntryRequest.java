...
import com.bat.thirdparty.erp.api.request.dto.ReceiveBillEntry;

public class CreateReceiveBillEntryRequest extends BaseTokenRequest {
    ...
    public String toString() {
        return "CreateReceiveBillEntryRequest{" + "FBillTypeID='" + FBillTypeID + '\'' + ", FDATE='" + FDATE + '\''
