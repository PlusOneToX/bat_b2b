...
import com.bat.thirdparty.erp.api.request.dto.RefundBillEntry;

public class CreateRefundBillRequest extends BaseTokenRequest {
    ...
    public String toString() {
        return "CreateRefundBillRequest{" + "FBillTypeID='" + FBillTypeID + '\'' + ", FDATE='" + FDATE + '\''
            + ", FPAYORGID='" + FPAYORGID + '\'' + ", FSETTLEORGID='" + FSETTLEORGID + '\'' + ", FCONTACTUNITTYPE='"
            + FCONTACTUNITTYPE + '\'' + ", FCONTACTUNIT='" + FCONTACTUNIT + '\'' + ", FRECTUNITTYPE='" + FRECTUNITTYPE
            + '\'' + ", FRECTUNIT='" + FRECTUNIT + '\'' + ", FCURRENCYID='" + FCURRENCYID + '\'' + ", refundBillDetail="
            + refundBillDetail + ", FDerivedFrom='" + FDerivedFrom + '\'' + ", FB2B_BILLNO='" + FB2B_BILLNO + '\''
            + '}';
    }
}
