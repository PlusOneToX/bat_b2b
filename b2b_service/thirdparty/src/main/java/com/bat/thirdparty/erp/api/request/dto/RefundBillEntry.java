...
public class RefundBillEntry {
    ...
    public String toString() {
        return "RefundBillEntry{" + "FSETTLETYPEID='" + FSETTLETYPEID + '\'' + ", FPURPOSEID='" + FPURPOSEID + '\''
            + ", FREFUNDAMOUNTFOR=" + FREFUNDAMOUNTFOR + ", FREALREFUNDAMOUNTFOR_D=" + FREALREFUNDAMOUNTFOR_D
            + ", FNOTE='" + FNOTE + '\'' + ", FORDERBILLNO='" + FORDERBILLNO + '\'' + ", FACCOUNTID='" + FACCOUNTID
            + '\'' + ", FHANDLINGCHARGEFOR=" + FHANDLINGCHARGEFOR + '}';
    }
}
