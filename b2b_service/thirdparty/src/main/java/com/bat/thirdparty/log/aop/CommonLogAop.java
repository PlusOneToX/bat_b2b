package com.bat.thirdparty.log.aop;
...
public class CommonLogAop extends BaseController {
    ...
    @Pointcut("@annotation(com.bat.thirdparty.log.annotation.SysLog)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, SysLog sysLog) throws Throwable {
        ...
        try {
            ...
            String userName = getContactName();
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                messageSendService.commonLog("order-service", sysLog.businessFunction(), businessId, platform,
                    finalUserId, userName, sysLog.value(), operateDes, operateData, new Date());
    ...
    public void afterThrowing(JoinPoint joinPoint, SysLog sysLog, Exception ex) {
        try {
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                if (ex instanceof ThirdPartyBaseException) {
                    ThirdPartyBaseException thirdPartyBaseException = (ThirdPartyBaseException)ex;
                    code = thirdPartyBaseException.getCode().toString();
                    msg = thirdPartyBaseException.getMsg();
                }
                if (ex instanceof ThirdPartyException) {
                    ThirdPartyException thirdPartyException = (ThirdPartyException)ex;
                    code = thirdPartyException.getCode();
                    msg = thirdPartyException.getMsg();
                }
                ...
                messageSendService.commonLog("thirdparty-service", sysLog.businessFunction(), businessId, platform,
                    finalUserId, userName, sysLog.value(), operateDes, operateData, new Date());
                TenantContext.removeTenantNo();
            });
        } catch (Exception e) {
