...
@Data
@ApiModel(description = "发货单日志查询")
public class OrderDeliverBillLogQry {
    ...
    @ApiModelProperty(value = "订单发货单id")
    private Integer orderDeliverBillId;

    @ApiModelProperty(value = "订单发货单ids")
    private List<Integer> orderDeliverBillIds;
