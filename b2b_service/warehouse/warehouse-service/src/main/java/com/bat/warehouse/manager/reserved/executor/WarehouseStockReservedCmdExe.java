...
@Component
public class WarehouseStockReservedCmdExe {
    ...
    public void create(WarehouseStockReservedDO warehouseStockReservedDO) {
        warehouseStockReservedDOMapper.insert(warehouseStockReservedDO);
    }

    public void update(WarehouseStockReservedDO stockReservedDO) {
        warehouseStockReservedDOMapper.updateByPrimaryKey(stockReservedDO);
    }
}
