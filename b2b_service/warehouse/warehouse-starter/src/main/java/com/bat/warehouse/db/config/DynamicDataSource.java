package com.bat.warehouse.db.config;

import static com.bat.warehouse.common.ErrorCode.TENANT_DB_NULL;
import static com.bat.warehouse.common.ErrorCode.TENANT_NO_NULL;
...
import com.bat.warehouse.common.ApplicationContextProvider;
import com.bat.warehouse.db.service.executor.TenantDBQry;
    ...
    protected DataSource determineTargetDataSource() {
        ...
        if (needReinit) {
            ...
            if (needReinit && StringUtils.isNotBlank(tenantNo) && !"null".equals(tenantNo)) {
                ...
                throw new WarehouseException(MessageUtils.get(TENANT_NO_NULL));
            }
        }
        // ------------------------------------------------------------------------------防御结束
        return dataSource;
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (StringUtils.isNotBlank(TenantContext.getTenantNo())) {
            ...
            if (StringUtils.isBlank(dbName)) {
                ...
                if (tenantDB == null) {
                    throw new WarehouseException(MessageUtils.get(TENANT_DB_NULL));
                }
                dbName = tenantDB.getDbName();
