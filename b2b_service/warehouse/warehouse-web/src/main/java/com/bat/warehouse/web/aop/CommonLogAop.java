package com.bat.warehouse.web.aop;
...
public class CommonLogAop extends BaseController {
    ...
    @Pointcut("@annotation(com.bat.warehouse.web.annotation.SysLog)")
    ...
    public void afterThrowing(JoinPoint joinPoint, SysLog sysLog, Exception ex) {
        try {
            ...
            threadPoolTaskScheduler.submit(() -> {
                ...
                if (ex instanceof WarehouseDubboApiException) {
                    WarehouseDubboApiException warehouseDubboApiException = (WarehouseDubboApiException)ex;
                    code = warehouseDubboApiException.getCode();
                    msg = warehouseDubboApiException.getMsg();
                }
                ...
                sendService.commonLog("warehouse-service", sysLog.businessFunction(), businessId, platform, finalUserId,
                    userName, sysLog.value(), operateDes, operateData, new Date());
                TenantContext.removeTenantNo();
            });
        } catch (Exception e) {
