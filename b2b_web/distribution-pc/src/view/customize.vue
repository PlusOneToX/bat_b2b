  ...
  <div class="wrap">
    <div class="customize">
      ...
      <div class="header rl-clear">
        ...
        <div class="rl-fr">
          <div class="shopcart" @click="make('add')">
            <img
              class="icon-shopcart"
          ...
          <div class="shopcart" @click="make('buy')">
            <img
              class="icon-buying"
              src="../../src/assets/images/buying.png"
              alt=""
            />立即购买
          </div>
        </div>
...
import { goodsDetails, priceItemList } from "@/apiService/api";
