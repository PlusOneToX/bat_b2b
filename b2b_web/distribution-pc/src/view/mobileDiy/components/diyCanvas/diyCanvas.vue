<!--
 * @Author: yaowei
 * @Date: 2018-05-08 10:22:11
 * @LastEditors: yaowei
 * @LastEditTime: 2018-05-08 10:47:49
-->
<template>
  <div>
    <div
...
export default {
  ...
  methods: {
    ...
    importFile(image, pdfimg) {
      ...
      if (
        baseUrl.indexOf("www.bat.com") > 0
      ) {
        this.uploadFile(imgFile, pdfFile, "b2bH5");
      } else {
        this.uploadFile(imgFile, pdfFile, "b2bH5_test");
      }
    },
...
.canvas-wrapper {
  ...
  .add-img {
    ...
    .lineHeight(8rem);
    .align(center);
    border: 0.1rem dashed @color-line;
  ...
  .dash-border {
    ...
    left: 50%;
    transform: translate3d(-50%, -50%, 0);
    border: 0.1rem dashed @color-red;
    z-index: 9;
  }
...
.clicked-area {
  ...
  .tips {
    ...
    &:before {
      ...
      border-top: 0.6rem solid rgba(49, 49, 49, 0.9);
    }
