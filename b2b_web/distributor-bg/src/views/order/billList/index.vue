<template>
  <transition name="fade" mode="out-in">
    <div class="warehouse-list">
      ...
      <el-table :data="tableData" border max-height="700" style="width:100%" header-row-class-name="header-row" class="tableCenter">
...
// import {getAllocationList} from '@/views/order/orderData'
