<template>
  <div class="adduser">
      ...
      <el-table
        ...
        <el-table-column label="账号中心ID" align="center" prop="rockAccountId" show-overflow-tooltip :formatter="formRockData"></el-table-column>
      ...
      <page :total="total" @sizeChange="sizeChange" @currentChange="currentChange"></page>
        <el-button class="mini-search-btn" style="margin-left: 45%;margin-top:20px;" autofocus size="mini" @click="handleSubmit"> 确定</el-button>
...
import {adminAddData} from "@/views/system/systemData";
  export default {
    ...
    methods: {
      ...
      handleSubmit() { // 选中的用户名值
        this.$emit('submitTen',this.multipleSelect);
      },
