<template>
  <div class="adduser">
    <el-row>
      <el-table :data="allSales" border header-row-class-name="header-row" class="adduser-table" ref='multipleSelect'  @selection-change="handleSelectionChange">
    ...
    <el-row>
      <el-col :span="2" :offset="9">
        <el-button autofocus class="mini-search-btn" @click="handleSubmitSix"> 确定</el-button>
      </el-col>
