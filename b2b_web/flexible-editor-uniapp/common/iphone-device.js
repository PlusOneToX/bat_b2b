...
function getModel(renderer) {
    ...
    if (window.screen.height / window.screen.width === 1024 / 768) {
        ...
        window.screen.height / window.screen.width === 932 / 430 &&
        ...
        window.screen.height / window.screen.width === 852 / 393 &&
        window.devicePixelRatio === 3
    ) {
        switch (renderer) {
            case "Apple A15 GPU":
        ...
        switch (renderer) {
            ...
            default:
                return "iPhone 13 Pro Max, iPhone 12 Pro Max, iPhone 14";
        }
        // iPhone 12 / 12 Pro / 13 / 13 Pro
    } else if (
        ...
        window.screen.height / window.screen.width === 780 / 360 &&
        window.devicePixelRatio === 3
    ) {
        switch (renderer) {
            case "Apple A14 GPU":
        ...
        window.screen.height / window.screen.width === 568 / 320 &&
        window.devicePixelRatio === 2
    ) {
        switch (renderer) {
            case "PowerVR SGX 543":
        ...
        window.screen.height / window.screen.width === 480 / 320 &&
        window.devicePixelRatio === 2
    ) {
        switch (renderer) {
            case "PowerVR SGX 535":
