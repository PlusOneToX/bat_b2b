/*
 * @Author: yaowei
 * @Date: 2019-12-02 13:42:55
 * @LastEditors: yaowei
 * @LastEditTime: 2019-11-30 15:34:42
 */
/*!*********************************************************************
 ...
 ********************************************************************** */
export function getRenderer(P, r) {
    /*! VERSION = 1.612128 */
    var U = [
        {
            x: "Unknown",
            m: function (e) {
                return (function () {
                    var e = /iPhone|iPad|Macintosh/.exec(navigator.userAgent);
        ...
        { x: "Apple A8 GPU", v: [839732043, 3816812019, 4125234388] },
        ...
        { x: "Apple A8 GPU", v: [3128296539, 3816812019, 4125234388] },
        ...
        {
            x: "Apple A8 GPU|Apple A8X GPU",
            v: [1350183384, 1361285941, 3816812019],
        },
        {
    ...
    function p() {
        var o,
            ...
            d = {
                create: function () {
                    for (var e = new Array(16), p = 0; p < 16; p++)
                        e[p] = p % 5 == 0 ? 1 : 0;
                    return e;
                },
                perspective: function (e, p, A, n, r) {
                    var t,
                        l = 1 / Math.tan(p / 2);
                    return (
                        (e[0] = l / A),
                ...
                multiply: function (e, p, A) {
                    ...
                    return (
                        ...
                        (e[8] = m * n + s * P + X * o + g * c),
                        (e[9] = m * r + s * U + X * i + g * f),
                        (e[10] = m * t + s * G + X * u + g * x),
                        (e[11] = m * l + s * a + X * v + g * h),
                        (m = A[12]),
                        (s = A[13]),
                        (X = A[14]),
                        (g = A[15]),
                        (e[12] = m * n + s * P + X * o + g * c),
                        (e[13] = m * r + s * U + X * i + g * f),
                        (e[14] = m * t + s * G + X * u + g * x),
                        (e[15] = m * l + s * a + X * v + g * h),
                        e
                    );
                },
                identity: function (e) {
        ...
        var e = 0;
        if (null != (i = document.createElement("canvas"))) {
            var p = (function () {
                if (
                    (o = (function () {
                        (i.width = 67), (i.height = 67);
                        var e =
                            i.getContext("webgl") ||
                    ...
                    var e = o.createShader(o.VERTEX_SHADER);
                    o.shaderSource(
                        e,
                        ...
                        o.compileShader(e);
                    var p = o.createShader(o.FRAGMENT_SHADER);
                    o.shaderSource(
                        p,
                    ...
                    var A = (function (e) {
                        ...
                        var g = e.getAttribLocation(b, "c");
                        e.vertexAttribPointer(g, 3, e.FLOAT, !1, 0, 0),
                            e.enableVertexAttribArray(g),
                            e.bindBuffer(e.ARRAY_BUFFER, s),
                            e.bufferData(e.ARRAY_BUFFER, r, e.STATIC_DRAW);
                        var d = e.getAttribLocation(b, "d");
                        return (
                    ...
                    o.clearColor(0, 0, 0, 1), o.enable(o.DEPTH_TEST);
                    var n = d.create();
                    d.perspective(n, Math.PI / 6, 1, 0.1, 100);
                    var r = d.create();
                    d.lookAt(r, [0, 0, 10], [0, 0, 0], [0, 1, 0]);
                    var t = d.create();
                    d.multiply(t, n, r);
                    var l = o.getUniformLocation(b, "h");
                    o.uniformMatrix4fv(l, !1, r);
                    var P = o.getUniformLocation(b, "i");
                    o.uniformMatrix4fv(P, !1, t);
                    var U = o.getUniformLocation(b, "e");
                    o.uniform4fv(U, [10, 10, 10, 1]);
                    var G = o.getUniformLocation(b, "f");
                    o.uniform3fv(G, [0.9, 0.5, 0.3]);
                    var a = o.getUniformLocation(b, "g");
                    return (
                        o.uniform3fv(a, [1, 1, 1]),
    ...
    function e() {
        ...
        function U(e) {
            e.terminate(), A(e.state);
        }
        function G(e) {
            clearTimeout(e.currentTarget.timeout);
            var p = e.currentTarget.state;
            e.currentTarget.terminate(),
                (p.samples = p.samples.concat(e.data)),
                A(p);
        }
        function A(e) {
            e.active--, 0 === e.active && ((t = e.samples), e.resolve(t));
        }
        function n(A, n, e) {
            fetch(e, { mode: "same-origin" })
                .then(function (e) {
                    if (e.ok)
                        !(function (e, p, A) {
                            var n = [],
                                r = new P();
                            (r.resolve = e), (r.reject = p);
                            try {
                                for (var t = 0; t < 2; t++) {
                                    var l = new Worker(A);
                                    (l.state = r),
                        ...
                        var p = new Error("Url could not be reached");
                        (p.response = e), n(p);
                    }
                })
                .catch(function (e) {
    ...
    function n(r) {
        return e()
            .then(function (e) {
                var p = 0;
                if (0 < e.length) {
                    var A = e.reduce(function (e, p) {
                            return p + e;
                        }),
                        n = 0 < e.length ? A / e.length : 0;
                    p =
                        e.reduce(function (e, p) {
                            return e + Math.pow(p - n, 2);
                        }, 0) /
                        (e.length - 1);
                }
                i(r, p, 0);
    ...
    function l(e) {
        for (var p = 2166136261, A = 0; A < e.length; ++A)
            (p ^= e.charCodeAt(A)),
    ...
    function G() {
        ...
        if (null != p) {
            var A = (function (e) {
                ...
                var p = e.getContext("2d", { alpha: !0 });
                if (null != p)
                    return (
                        (p.imageSmoothingQuality = "low"),
                        ...
                        (p.font = "10pt Arial"),
                        (p.lineWidth = 2),
                        void 0 !== p.setLineDash && p.setLineDash([10, 20]),
                        (p.shadowColor = "black"),
                        (p.shadowOffsetX = -3),
                        (p.shadowOffsetY = -5),
                        p.translate(e.width / 2, e.height / 2),
                        p.rotate(0.8901179),
                        (p.fillStyle = "green"),
                        (p.textAlign = "center"),
                        (p.textBaseline = "middle"),
                        p.fillText("*51Degrees*", 0, 0),
                        p.beginPath(),
                        (p.shadowColor = "yellow"),
                        (p.shadowBlur = 1),
                        (p.shadowOffsetX = 1),
                        (p.shadowOffsetY = 1),
                        (p.strokeStyle = "red"),
                        (p.fillStyle = "rgba(0, 0, 255, 0.6)"),
                        void 0 === p.ellipse
                            ? p.arc(0, 0, 25, 0, 2 * Math.PI)
                            : p.ellipse(
                                  0,
                                  0,
                                  25,
    ...
    function i(e, p, A) {
        for (var n = 0; n < e.n.length; n++) {
            ...
            else if (r.v && -1 != r.v.indexOf(p)) return void u(r, 0);
        }
        0 < e.n.length &&
            A < 10 &&
            setTimeout(function () {
