    ...
    <div class="tab-ul">
      ...
      >
        <!-- 
            ...
            金额是否到达要求 amountEnable: 1 达到，0 未达到
        ...
        >
          ...
          <div class="coupon-m">
            ...
            <div class="datetime" v-show="!isToday(item.endTime)">
              {{ item.startTime | formatDay }}-{{
                item.endTime | formatDay
              }}有效
            </div>
          </div>
          <!-- 待领取 -->
        ...
        <div class="coupon-info none" :id="`info` + index">
          <div class="title" v-show="status !== 1 && item.createTime">
