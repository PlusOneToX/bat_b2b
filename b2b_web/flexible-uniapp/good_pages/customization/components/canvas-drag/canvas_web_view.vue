<template>
    <view>
        ...
        <view @touchstart="start" @touchmove="move" @touchend="end" :class="Isopacity?'iscanvas_copy':''" class="image_box" :style="{height:modelHeight+'rpx',borderTop: '100rpx solid #efeff4',borderLeft: leftFrameVar+'rpx solid #efeff4',borderRight: leftFrameVar+'rpx solid #efeff4',borderBottom: '104rpx solid #efeff4'}">
...
.hollow_out {
    margin: 0 auto;
    z-index: 8;
    // border-color: #efeff4; /* this won't really be seen */
    // border-style: solid; /* this won't rea*/
    // display: block !important;
    // 带有透明图像的CSS边框图像在部分Android机上会显示出边缘来
