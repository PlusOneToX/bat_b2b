<template>
    ...
    <uni-popup ref="popup" :safeArea="false" type="bottom" @maskClick="close">
        <view class="sele_img_box">
            ...
            <view class="input_item">
                <view class="input_meu" :style="{'color':pickerColor,fontFamily: fontFile,fontWeight:wordStyle.fontWeight,textDecoration:wordStyle.textDecoration, fontStyle:wordStyle.fontStyle}">
                    <input :adjust-position="false" placeholder=" 请输入文字" v-model="value" />
                </view>
            ...
            <view v-if="IsseleceWord">
                ...
                <!-- #ifdef H5 -->
                <slider-picker style="width: 690rpx;margin: 0 auto;" v-model="colors" :swatches="swatches" @input="updateValue" />
                <!-- #endif -->
                <view class="typeface_style_box">
                    <view class="typeface_style_meu" @click="overstriking">
                        <image src="../../../static/icons/overstriking.png"></image>
                    </view>
                    <view class="typeface_style_meu" @click="incline">
                        <image src="../../../static/icons/italic.png"></image>
                    </view>
                    <view class="typeface_style_meu" @click="underline">
                        <image src="../../../static/icons/underline.png"></image>
                    </view>
