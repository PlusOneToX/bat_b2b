    ...
    <view class="coupon">
        <view class="container-wrapper">
            ...
            <view class="coupon-list">
                <view class="title">
                    <view class="title-name">Galaxy A52 5G用户定制专享</view>
                </view>
            ...
            <view class="pic-list">
                ...
                <view class="pic-ul">
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450781101.blob:http://localhost:8080/34db92ef-e3d6-4b7d-a7dd-86fab7d6fa3f" v-lazy="'https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450781101.blob:http://localhost:8080/34db92ef-e3d6-4b7d-a7dd-86fab7d6fa3f'" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450911581.blob:http://localhost:8080/e4390db3-ebdf-441c-8017-e3e4d1c88469" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450924090.blob:http://localhost:8080/a629abfa-c651-4a40-b8d4-992503784cff" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450942501.blob:http://localhost:8080/61907c30-9bef-40a4-b51e-c761aabff1af" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450953749.blob:http://localhost:8080/e211f604-8ff0-4260-a88f-8fa627bedce9" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450964207.blob:http://localhost:8080/367b4b21-abf0-4039-a508-a28f925d01de" />
                    </view>
                </view>
            </view>
            <!-----热门定制图案一览----->
            <view class="pic-list">
                ...
                <view class="pic-ul">
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451173978.blob:http://localhost:8080/4d6f813b-56ab-449a-a31f-d9154c0e7c8c" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451185097.blob:http://localhost:8080/1c984ec9-4efd-49c5-bf13-3463b734d59f" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451196739.blob:http://localhost:8080/e2861dbd-4367-4efc-a908-a041bdb4fa79" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451208063.blob:http://localhost:8080/f2348951-0f2e-4326-be79-80cbc5f013e7" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451219778.blob:http://localhost:8080/bb6fde46-5df0-4dfd-a32a-5fbf276c89f8" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451231235.blob:http://localhost:8080/297e2b0a-a55e-4e87-a035-d5e14636387e" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451244686.blob:http://localhost:8080/9c0ddea5-eda4-4d20-af65-0b40ba57d976" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451261449.blob:http://localhost:8080/217d9a11-99e7-411d-b474-b07fea35ab61" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676451274019.blob:http://localhost:8080/297daead-a865-4a6f-b21b-3d520c05889b" />
                    </view>
                </view>
            </view>
        </view>
  ...
  .coupon {
      ...
      .container-wrapper {
          ...
          .header-img {
              ...
              width: 100%;
              height: 230px;
              background-image: url('https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676450170026.png');
