    ...
    <view class="coupon">
        <view class="container-wrapper">
            ...
            <view class="coupon-list">
                <view class="title">
                    <view class="title-name">618活动专属福利</view>
                </view>
    ...
    methods: {
        ...
        _initDate(couponTypes, statuss) {
            if (this.userId) {
                ...
                uni.hideLoading()
                uni.navigateTo({
                    url: "../login/login?platform=" + this.platform + "&distributorId=" + this.distributorId + "&sa=4&ids=" + this.ids + "&samFlag=samA52Flag&hasQualified=" + this.hasQualified
                });
            }
        },
        onSamLogin(saInfo) {
        ...
        getCoupon(ids) {
            ...
            this.$api
                .post(this, api.receiveCoupon, { ids: this.ids })
                .then((res) => {
                    if (res.success) {
                        // 领取成功 - 跳转首页
                        uni.showToast({
  ...
  .coupon {
      ...
      .container-wrapper {
          ...
          .header-img {
              ...
              width: 100%;
              height: 230px;
              background-image: url('https://bat-com.oss-cn-shenzhen.aliyuncs.com/diy/h51685070107364.blob:http://localhost:8080/480ebd5e-7dfc-470f-ad9c-940c2143460d');
