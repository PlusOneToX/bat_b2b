    ...
    <view class="coupon">
        <view class="container-wrapper">
            ...
            <view class="coupon-list">
                <view class="title">
                    <view class="title-name">Galaxy S20 FE 5G用户定制专享</view>
                </view>
            ...
            <view class="pic-list">
                ...
                <view class="pic-ul">
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453133318.blob:http://localhost:8080/78a592c9-dd0e-46ff-993a-d4cbc89efad6" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453193954.blob:http://localhost:8080/0cb7600a-fa24-4be6-b7a3-34fba55b4cba" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453206368.blob:http://localhost:8080/38f05d67-e64a-4bd5-be3a-d3f3b8b8b23b" />
                    </view>
                    <view class="pic-li">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453217902.blob:http://localhost:8080/aeab32a2-bd17-44fc-8733-773c51f393e2" />
                    </view>
            ...
            <view class="pic-list">
                ...
                <view class="pic-ul">
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453355652.blob:http://localhost:8080/7b161588-4897-4e64-90ce-1d4a89bce755" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453366860.blob:http://localhost:8080/c82f4630-9ef8-44b6-8fce-ba15c4851512" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453378779.blob:http://localhost:8080/eeabed7e-9cb2-4561-bd58-1a12300dde73" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453390873.blob:http://localhost:8080/0cd966d2-2c0f-47ce-a291-1f960fbf2711" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453401568.blob:http://localhost:8080/baebde5e-d815-4c26-83ee-d3436907db90" />
                    </view>
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453412678.blob:http://localhost:8080/da91f984-fcf5-4cfe-9b3f-75fb97f88aec" />
                    </view>
                    <view class="pic-li three">
                    ...
                    <view class="pic-li three">
                        <img class="img" src="https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453423246.blob:http://localhost:8080/db8e5218-77e4-461d-877e-07bbf47cf533" />
                    </view>
                    <view class="pic-li three">
  ...
  .coupon {
      ...
      .container-wrapper {
          ...
          .header-img {
              ...
              width: 100%;
              height: 230px;
              background-image: url('https://bat.oss-cn-shenzhen.aliyuncs.com//diy/h51676453050798.blob:http://localhost:8080/84d47267-49a6-4523-9386-544c557cae28');
